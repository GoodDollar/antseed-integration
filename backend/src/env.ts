export interface Env {
  ...
  ANTSEED_MIN_BUYER_DEPOSIT_MICRO_USD?: string;
...
export type RuntimeConfig = {
  ...
  ANTSEED_FUNDING_VAULT_ADDRESS?: string;
  ANTSEED_FUNDING_OPERATOR_PRIVATE_KEY?: string;
  ANTSEED_MIN_BUYER_DEPOSIT_MICRO_USD: bigint;
...
export function configFromEnv(env: Env): RuntimeConfig {
  return {
    ...
    ANTSEED_MIN_BUYER_DEPOSIT_MICRO_USD: bigintEnv(env.ANTSEED_MIN_BUYER_DEPOSIT_MICRO_USD, 10_000_000n),
